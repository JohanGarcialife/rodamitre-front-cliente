...
import {modelosVeApi, productosMarModelo, rubroModeloS, motorRM }from "@/pages/api/productos";
...
export default function BuscadorVehiculo(props) {
  ...
  const [seledRubro, setSeledRubro] = useState([]);
...
var autoSelect = marcaAutos?.map(function (obj) {
  ...
  var rubroSelect = seledRubro?.map(function (obj) {
    var rObj = {
      value: obj?.rup_id,
