...
`;
  ...
  return (
    <>
    <form className="flex space-x-10 w-full font-montserrat" onSubmit={handleSubmit}>
      ...
      <div className="flex h-fit bg-amarillo text-white rounded-lg  ">
        <button className="flex items-center space-x-2 p-3 hover:bg-azul rounded-l-lg cursor-pointer" type="submit"
        >
          <p>Buscar</p>
          <FaSearch />
        </button>
